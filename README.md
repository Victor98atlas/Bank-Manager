This project is a bank management system which is completely programmed using c language.To initialize this project,I would personally recommend you run it on the terminal using gcc compiler.
